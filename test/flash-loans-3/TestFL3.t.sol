...
contract TestFL3 is Test {
    ...
    address constant WETH_USDC_PAIR = address(0xB4e16d0168e52d35CaCD2c6185b44281Ec28C9Dc);
    // $40M USDC
    uint256 BORROW_AMOUNT = 40000000e6;
    // Uniswap V2 fee is 0.3% which is $1.2M USDC
    uint256 FEE_AMOUNT = ((BORROW_AMOUNT * 3) / 997) + 1;
    ...
    function setUp() public {
        ...
        flashSwap = new FlashSwap(WETH_USDC_PAIR, FEE_AMOUNT);
    }
